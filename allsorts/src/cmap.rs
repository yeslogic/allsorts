...
include!(concat!(env!("OUT_DIR"), "/cmap.rs"));
...
impl CMap {
    ...
    pub fn find_subtable_for_platform(&self, platform_id: u16) -> Option<(u16, u32)> {
    ...
    pub fn find_subtable(&self, platform_id: u16, encoding_id: u16) -> Option<u32> {
        self.encoding_records
            .iter()
            .find(|record| {
...
mod test {
    ...
    fn empty_data() {
        ...
        assert!(CMap::read(&mut cursor).is_err());
    }
    ...
    fn empty_subtables() {
        ...
        let mut cursor = Cursor::new(data);
        let cmap = CMap::read(&mut cursor).unwrap();
    ...
    fn one_encoding_record() {
        ...
        assert_eq!(cmap.encoding_records[0].subtable_offset, 256);
    }
    ...
    fn two_encoding_records() {
        ...
        assert_eq!(cmap.encoding_records[1].subtable_offset, 513);
    }
