...
fn metadata() -> String {
    include_str!("./fonts/woff1/metadata.xml")
    .trim()
    .to_string()
}
...
#[test]
fn test_valid001() {
    let buffer = include_bytes!("tests/fonts/woff1/valid-001.woff");
...
#[test]
fn test_valid002() {
    let buffer = include_bytes!("tests/fonts/woff1/valid-002.woff");
    let result = ReadScope::new(&buffer).read::<WoffFont>().unwrap();
...
#[test]
fn test_valid005() {
    let buffer = include_bytes!("tests/fonts/woff1/valid-005.woff");
    let result = ReadScope::new(&buffer).read::<WoffFont>().unwrap();
...
#[test]
fn test_valid006() {
    let buffer = include_bytes!("tests/fonts/woff1/valid-006.woff");
    let result = ReadScope::new(&buffer).read::<WoffFont>().unwrap();
...
fn test_header_reserved001() {
    let buffer = include_bytes!("tests/fonts/woff1/header-reserved-001.woff");
...
fn test_directory_overlaps_001() {
    let buffer = include_bytes!("tests/fonts/woff1/directory-overlaps-001.woff");
...
fn test_tabledata_zlib_001() {
    let buffer = include_bytes!("tests/fonts/woff1/tabledata-zlib-001.woff");
    let woff_file = ReadScope::new(&buffer).read::<WoffFont>().unwrap();
